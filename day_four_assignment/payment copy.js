class PaymentProcessor {                     //God Class thats doing too much eg Payment validation,Fraud checks,Discounts,Currency conversion,Analytics,Email sending,API communication,Refund processing.
